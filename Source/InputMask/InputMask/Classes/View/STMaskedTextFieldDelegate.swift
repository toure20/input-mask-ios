//
//  STMaskedTextFieldDelegate.swift
//  StarBanking
//
//  Created by Toremurat on 02.02.2021.
 ...
 */
@objc public protocol STMaskedTextFieldDelegateListener: UITextFieldDelegate {
 ...
 */
@IBDesignable
open class STMaskedTextFieldDelegate: NSObject, UITextFieldDelegate {
    ...
    open weak var listener: STMaskedTextFieldDelegateListener?
...
internal extension STMaskedTextFieldDelegate {
